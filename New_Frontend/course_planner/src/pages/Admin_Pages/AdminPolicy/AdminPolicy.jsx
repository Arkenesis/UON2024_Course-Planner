...
const AdminPolicy = () =>{
    ...
    //             this Privacy Policy. This Privacy Policy has been created with the help of the Privacy Policy Generator.
    //         </p>
    ...
    //             <li>
    //                 Affiliate means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of 
    //                 the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.
    //             </li>
    //             <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Newcastle Planner.</li>
    //             <li>
    ...
    //             <li>
    //                 Service Provider means any natural or legal person who processes the data on behalf of the Company. It refers to third-party companies or individuals 
    ...
    //             </li>
    //             <li>
    //                 Usage Data refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, 
    //                 the duration of a page visit).
    //             </li>
    //             <li>Website refers to Newcastle Planner, accessible from <a href="http://www.uoncourseplanner.co"></a>http://www.uoncourseplanner.co</li>
    //             <li>
    ...
    //         <h4>Usage Data</h4>
    //         <p>
    //             Usage Data is collected automatically when using the Service.<br/><br/>Usage Data may include information such as Your Device's Internet Protocol address 
    ...
    //         <ul>
    //             <li>
    //                 Cookies or Browser Cookies. A cookie is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate when a 
    //                 Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service. Unless you have adjusted Your browser 
    //                 setting so that it will refuse Cookies, our Service may use Cookies.
    //             </li>
    //             <li>
    //                 Web Beacons. Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, 
    //                 pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other 
    //                 related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).
    //             </li>
    //         </ul>
    //         <p>
    ...
    //             Cookies are deleted as soon as You close Your web browser. You can learn more about cookies on the TermsFeed website article.
    //         </p>

    //         <h2>We use both Session and Persistent Cookies for the purposes set out below:</h2>
    //         <ul>
    ...
    //             </li>
    //             <li>
    //                 For the performance of a contract: the development, compliance and undertaking of the purchase contract for the products, items or services You have 
    //                 purchased or of any other contract with Us through the Service.
    //             </li>
    //             <li>
    //                 To contact You: To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's 
    ...
    //             <li>
    //                 For business transfers: We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of 
    ...
    //             <li>
    //                 With other users: when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by 
    ...
    //         <p>
    //             You have the right to delete or request that We assist in deleting the Personal Data that We have collected about You.<br/><br/>Our Service may give 
    //             You the ability to delete certain information about You from within the Service.
    //         </p>
    //         <p>
    ...
    //             party's site. We strongly advise You to review the Privacy Policy of every site You visit.<br/><br/>We have no control over and assume no 
        ...
        <>
            ...
            <div className={styles.editorContainer}>
                ...
                <div className={styles.buttonsContainer}>
                    <Link to="../policy" target='_blank' className={styles.preview}>Preview</Link>
