...
const filterCourses = courses.filter(course =>
  ...
  return (
    ...
    <div ref={node => drag(drop(node))} key={index} style={{ opacity: isDragging? 1: 1, position: "relative", height: "220px",display: "flex", justifyContent: "center", alignItems: "center", width: "240px", background: isActive ? "#FED766" : "" }} className="trimesterBox"  >
